...
use crate::{utils::{get_allocation_fn_name_by_ident, get_ident_of_field_type, get_type_params_from_generics, get_type_path_of_field, get_witness_ident, has_engine_generic_param}, witness::derive_witness_struct};
...
pub(crate) fn derive_alloc(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    if has_engine_generic_param(&generics.params, &engine_generic_param) == false && has_engine_generic_param(&witness_struct.generics.params, &engine_generic_param) == false{
